...
export default {
  ...
  methods: {
    ...
    createRoom () {
      var userToken = window.localStorage.getItem('user') ? JSON.parse(window.localStorage.getItem('user')).userToken : null
      this.$axios.post('/room/create', {
        userName: window.localStorage.getItem('user') ? JSON.parse(window.localStorage.getItem('user')).userName : null,
        gameType: 2,
        maxNumber: 4
    ...
    addFriend () {
      this.$axios.post('/account/addfriend', {
        userA: window.localStorage.getItem('user') ? JSON.parse(window.localStorage.getItem('user')).userName : null,
